...
impl eframe::App for MyApp {
    fn ui(&mut self, ui: &mut egui::Ui, frame: &mut eframe::Frame) {
        egui::Panel::left("left")
            .resizable(true)
            .show_inside(ui, |ui| {
                egui::Panel::top("shopping list")
                    .resizable(false)
                    .show_inside(ui, |ui| {
                        ui.vertical_centered(|ui| ui.heading("Your shopping list"));
                ...
                ui.checkbox(&mut self.include_paknsave, "Pak'n'Save");
                ui.checkbox(&mut self.include_newworld, "New World");
                ui.checkbox(&mut self.include_woolies, "Woolworths");
            });
        egui::CentralPanel::default_margins().show_inside(ui, |ui| ui.heading("right"));
    }
}
